...
const checkModelController = ($rootScope, $scope, baseService, $sce, programService, $filter,modalService) => {
	$scope.displayed = [];
	$scope.sp = {};
	$scope.tableState = {};
...
checkModelController.$inject = ['$rootScope', '$scope', 'baseService', '$sce', 'programService', '$filter','modalService'];
