...
const authorizationdetailController = ($scope, baseService, modalService) => {
	$scope.displayed = [];
	$scope.sp = {};
	$scope.tableState = {};
	...
	$scope.save = (item) => {
		...
		modalService.confirmDialog(540, item ? '编辑授权码' : '添加授权码', postData, '/static/tpl/authorizationdetail_save.html', (vm) => {
...
authorizationdetailController.$inject = ['$scope', 'baseService', 'modalService'];
