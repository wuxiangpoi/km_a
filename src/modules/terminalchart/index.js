const terminalchartController = ($scope, baseService,chartService) => {
    $scope.sp = {};
	var now = new Date();
...
terminalchartController.$inject = ['$scope', 'baseService','chartService'];

export default angular => {
    return angular.module('terminalchartModule', []).controller('terminalchartController', terminalchartController);
}